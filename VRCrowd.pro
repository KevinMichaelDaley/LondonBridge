...
unrealRootPath=/home/kmd/UnrealEngine
VRCrowdRootPath=/home/kmd/Documents/Unreal Projects/VRCrowd

gameProjectFile=/home/kmd/Documents/Unreal Projects/VRCrowd/VRCrowd.uproject
...
include(VRCrowdSource.pri)
include(VRCrowdHeader.pri)
include(VRCrowdConfig.pri)
include(VRCrowdIncludes.pri)
include(VRCrowdDefines.pri)

VRCrowd-Linux-Debug.commands = $$build VRCrowd Linux Debug  -project="\"$$gameProjectFile\"" $$args
VRCrowd-Linux-DebugGame.commands = $$build VRCrowd Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
VRCrowd-Linux-Shipping.commands = $$build VRCrowd Linux Shipping  -project="\"$$gameProjectFile\"" $$args
VRCrowd-Linux-Test.commands = $$build VRCrowd Linux Test  -project="\"$$gameProjectFile\"" $$args
VRCrowd.commands = $$build VRCrowd Linux Development  -project="\"$$gameProjectFile\"" $$args

VRCrowdEditor-Linux-Debug.commands = $$build VRCrowdEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
VRCrowdEditor-Linux-DebugGame.commands = $$build VRCrowdEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
VRCrowdEditor-Linux-Shipping.commands = $$build VRCrowdEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
VRCrowdEditor-Linux-Test.commands = $$build VRCrowdEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
VRCrowdEditor.commands = $$build VRCrowdEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	VRCrowd-Linux-Debug \
	VRCrowd-Linux-DebugGame \
	VRCrowd-Linux-Shipping \
	VRCrowd-Linux-Test \
	VRCrowd \
	VRCrowdEditor-Linux-Debug \
	VRCrowdEditor-Linux-DebugGame \
	VRCrowdEditor-Linux-Shipping \
	VRCrowdEditor-Linux-Test \
	VRCrowdEditor \
