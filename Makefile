...
VRCrowd-Linux-Debug:
	 $(PROJECTBUILD) VRCrowd Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRCrowd-Linux-DebugGame:
	 $(PROJECTBUILD) VRCrowd Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRCrowd-Linux-Shipping:
	 $(PROJECTBUILD) VRCrowd Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRCrowd-Linux-Test:
	 $(PROJECTBUILD) VRCrowd Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRCrowd:
	 $(PROJECTBUILD) VRCrowd Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRCrowdEditor-Linux-Debug:
	 $(PROJECTBUILD) VRCrowdEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRCrowdEditor-Linux-DebugGame:
	 $(PROJECTBUILD) VRCrowdEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRCrowdEditor-Linux-Shipping:
	 $(PROJECTBUILD) VRCrowdEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRCrowdEditor-Linux-Test:
	 $(PROJECTBUILD) VRCrowdEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRCrowdEditor:
	 $(PROJECTBUILD) VRCrowdEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
